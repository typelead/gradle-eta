...
```gradle
plugins {
    id 'com.typelead.eta.base' version '0.7.4'
}
```
...
```gradle
plugins {
    id 'com.typelead.eta' version '0.7.4'
}
```
...
```gradle
plugins {
    id 'com.typelead.eta.android' version '0.7.4'
}
```
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.com.typelead:gradle-eta:0.7.4'
  }
}
```
