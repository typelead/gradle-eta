...
[![Gradle Plugin Portal](https://img.shields.io/badge/com.typelead.eta-0.7.6-green.svg?longCache=true&style=plastic)](https://plugins.gradle.org/plugin/com.typelead.eta)
[![Gradle Plugin Portal](https://img.shields.io/badge/com.typelead.eta.android-0.7.6-green.svg?longCache=true&style=plastic)](https://plugins.gradle.org/plugin/com.typelead.eta.android)
[![Gradle Plugin Portal](https://img.shields.io/badge/com.typelead.eta.base-0.7.6-green.svg?longCache=true&style=plastic)](https://plugins.gradle.org/plugin/com.typelead.eta.base)
...
```gradle
plugins {
    id 'com.typelead.eta.base' version '0.7.6'
}
```
...
```gradle
plugins {
    id 'com.typelead.eta' version '0.7.6'
}
```
...
```gradle
plugins {
    id 'com.typelead.eta.android' version '0.7.6'
}
```
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.com.typelead:gradle-eta:0.7.6'
  }
}
```
